...
def after_install():
	...
	# Only add is_credit_card if it is not already a standard field in Bank Account
		...
		# Only add Bank Transaction fields if not already standard fields in ERPNext v16
	...
	# Only add reconciliation_type if it is not already a standard field in Bank Transaction Payments
	existing_fieldnames = [
